...
def test_model(model, optimizer, data, device, pos_edge_index, neg_edge_index):
    ...
    # 记得隐藏掉
    data.edge_index_list = [data.edge_index_list[0]]
...
if __name__ == "__main__":
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print('Epoch: {:03d}, loss: {:.4f},acc:{:.4f},F1_score:{:.4f}, AUC: {:.4f}, AP: {:.4f}, val_loss: {:.4f}, precision@5: {:.4f}, precision@10: {:.4f}'.format(epoch,
    ...
    print("\ntest result:")
    print('acc:{:.4f},F1_score:{:.4f},AUC: {:.4f}, AP: {:.4f}, precision@5: {:.4f}, precision@10: {:.4f}'.format(results['acc'], results['F1_score'],results['AUC'], results['AUPR'],
